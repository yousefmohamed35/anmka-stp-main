...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get inPersonStudent => 'Offline student';
  ...
  @override
  String get verifyEmailHeadline => 'Check your inbox';

  @override
  String verifyEmailBody(String email) {
    return 'We sent a verification link to $email. Open the link in your email, then return here and sign in.';
  }
  ...
  @override
  String get clearAllOfflineVideos => 'Clear all offline videos';

  @override
  String get clearAllOfflineVideosConfirmTitle => 'Delete all offline videos?';
  ...
  String clearAllOfflineVideosSuccess(int count) {
    return 'Removed $count offline video(s).';
  }

  @override
  String get clearAllOfflineVideosFailed => 'Could not clear offline videos.';

  @override
  String get clearAllOfflineVideosNothing => 'No offline videos to remove.';

  @override
  String get clearAllOfflineVideosProgress => 'Clearing offline videos…';
  ...
  @override
  String get mandatoryUpdateTitle => 'Update required';

  @override
  String mandatoryUpdateBody(String current, String required) {
    return 'This version ($current) is no longer supported. Please install version $required or newer from the store.';
  }
