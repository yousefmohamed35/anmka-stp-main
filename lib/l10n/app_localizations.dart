...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'We sent a verification link to {email}. Open the link in your email, then return here and sign in.'**
  ...
  /// Settings action to remove all downloaded lesson videos from this device
  ///
  /// In en, this message translates to:
  /// **'Clear all offline videos'**
  String get clearAllOfflineVideos;

  /// Confirmation dialog title for clearing offline videos
  ///
  /// In en, this message translates to:
  /// **'Delete all offline videos?'**
  String get clearAllOfflineVideosConfirmTitle;

  /// Confirmation dialog body for clearing offline videos
  ///
  /// In en, this message translates to:
  /// **'This removes every lesson video saved on this device for offline viewing. It does not delete your account or course progress. You can download videos again when allowed and online.'**
  String get clearAllOfflineVideosConfirmBody;

  /// Snackbar after clearing offline videos
  ///
  /// In en, this message translates to:
  /// **'Removed {count} offline video(s).'**
  String clearAllOfflineVideosSuccess(int count);

  /// Error when clearing offline videos fails
  ///
  /// In en, this message translates to:
  /// **'Could not clear offline videos.'**
  String get clearAllOfflineVideosFailed;

  /// Shown when there are no downloaded videos
  ///
  /// In en, this message translates to:
  /// **'No offline videos to remove.'**
  String get clearAllOfflineVideosNothing;

  /// Loading text while bulk-deleting offline videos
  ///
  /// In en, this message translates to:
  /// **'Clearing offline videos…'**
  String get clearAllOfflineVideosProgress;
  ...
  /// Section title for past center attendance records
  ///
  /// In en, this message translates to:
  /// **'Attendance history'**
  String get attendanceHistory;

  /// Empty state when student has no attendance history
  ///
  /// In en, this message translates to:
  /// **'No attendance records yet'**
  String get noAttendanceRecords;

  /// Error when my-attendance API fails
  ///
  /// In en, this message translates to:
  /// **'Could not load attendance history'**
  String get errorLoadingAttendanceHistory;
  ...
  /// Title when app version is blocked until update
  ///
  /// In en, this message translates to:
  /// **'Update required'**
  String get mandatoryUpdateTitle;

  /// Explains blocked app version and required version
  ///
  /// In en, this message translates to:
  /// **'This version ({current}) is no longer supported. Please install version {required} or newer from the store.'**
  String mandatoryUpdateBody(String current, String required);

  /// Button to open app store for update
  ///
  /// In en, this message translates to:
  /// **'Update now'**
  String get updateNow;

  /// Shown when backend did not provide a store URL
  ///
  /// In en, this message translates to:
  /// **'Store link is not available. Please update the app from the store you installed it from.'**
  String get mandatoryUpdateStoreMissing;
}
