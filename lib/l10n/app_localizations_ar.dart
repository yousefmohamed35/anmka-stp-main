...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get inPersonStudent => 'طالب أوفلاين';
  ...
  @override
  String get verifyEmailHeadline => 'تحقق من بريدك';

  @override
  String verifyEmailBody(String email) {
    return 'أرسلنا رابط التحقق إلى $email. افتح الرابط من بريدك، ثم عد هنا وسجّل الدخول.';
  }
  ...
  String get resendVerificationSuccess =>
      'تم إرسال رسالة التحقق. يرجى مراجعة بريدك.';

  @override
  String get emailNotVerifiedLogin =>
      'يرجى تأكيد بريدك الإلكتروني قبل تسجيل الدخول. تحقق من صندوق الوارد للرابط.';
  ...
  @override
  String get clearAllOfflineVideos => 'مسح كل الفيديوهات المحمّلة';

  @override
  String get clearAllOfflineVideosConfirmTitle => 'حذف كل الفيديوهات المحمّلة؟';

  @override
  String get clearAllOfflineVideosConfirmBody =>
      'سيتم حذف كل فيديوهات الدروس المحفوظة على هذا الجهاز للمشاهدة بدون إنترنت. لا يُحذف حسابك أو تقدمك في الدورات. يمكنك إعادة التحميل لاحقاً إذا سُمح بذلك وكنت متصلاً بالإنترنت.';

  @override
  String clearAllOfflineVideosSuccess(int count) {
    return 'تمت إزالة $count فيديو محمّل.';
  }

  @override
  String get clearAllOfflineVideosFailed => 'تعذّر مسح الفيديوهات المحمّلة.';

  @override
  String get clearAllOfflineVideosNothing => 'لا توجد فيديوهات محمّلة للحذف.';

  @override
  String get clearAllOfflineVideosProgress => 'جاري مسح الفيديوهات المحمّلة…';
  ...
  @override
  String get noAttendanceRecords => 'لا توجد سجلات حضور بعد';

  @override
  String get errorLoadingAttendanceHistory => 'تعذر تحميل سجل الحضور';
  ...
  @override
  String get mandatoryUpdateTitle => 'يلزم التحديث';

  @override
  String mandatoryUpdateBody(String current, String required) {
    return 'الإصدار الحالي ($current) لم يعد مدعومًا. يرجى تثبيت الإصدار $required أو أحدث من المتجر.';
  }
  ...
  String get mandatoryUpdateStoreMissing =>
      'رابط المتجر غير متوفر. يرجى تحديث التطبيق من المتجر الذي ثبّتَه منه.';
}
